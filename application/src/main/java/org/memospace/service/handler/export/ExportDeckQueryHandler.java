...
public class ExportDeckQueryHandler implements QueryHandler<ExportDeckQuery, ExportModel> {
    ...
    public ExportModel handle(ExportDeckQuery query) {
        ...
        return exportService.exportDeck(query.getDeckId(), query.isIncludeMediaManifest());
    }
}
